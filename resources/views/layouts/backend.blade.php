...
<head>
    ...
    <!-- Modules -->
    @yield('css')
    @vite(['resources/sass/main.scss', 'resources/js/lacek/app.js'])

    <!-- Alternatively, you can also include a specific color theme after the main stylesheet to alter the default color theme of the template -->
    {{-- @vite(['resources/sass/main.scss', 'resources/sass/lacek/themes/xwork.scss', 'resources/js/lacek/app.js']) --}}
    @yield('js')
</head>
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="fw-semibold text-white tracking-wide" href="/">
                        ...
                        <span class="smini-hidden">
                            Lacek<span class="opacity-75">Admin</span>
                        </span>
                    </a>
                    <!-- END Logo -->
            ...
            <div class="content py-0">
                <div class="row fs-sm">
                    <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
                        Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="#" target="_blank">waw3</a>
                    </div>
                    <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                        <a class="fw-semibold" href="#" target="_blank">Lacek</a> &copy;
